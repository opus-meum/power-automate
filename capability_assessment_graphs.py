...
# Usage
slide = prs.slides[8]
add_formatted_textbox(slide, recommendations['Strategy'], -0.9, 1.7, 7, 1)
...
slide = prs.slides[7]
txBox_rec8 = slide.shapes.add_textbox(Inches(6), Inches(1.1), Inches(2), Inches(0.5)) #(Inches(1.36), Inches(1.165)
...
slide = prs.slides[7]
txBox_rec82 = slide.shapes.add_textbox(Inches(7), Inches(1.2), Inches(2), Inches(0.5)) #0.6, 1.35
