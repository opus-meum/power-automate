...
slide = prs.slides[7]
txBox_rec8 = slide.shapes.add_textbox(Inches(4.8), Inches(1.116), Inches(7), Inches(0.5)) #(Inches(1.36), Inches(1.165)
...
slide = prs.slides[7]
txBox_rec82 = slide.shapes.add_textbox(Inches(1), Inches(1.33), Inches(7), Inches(0.5)) #0.6, 1.35
