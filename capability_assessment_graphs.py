...
# Usage
slide = prs.slides[8]
add_formatted_textbox(slide, recommendations['Strategy'], -0.54, 1.7, 7, 1)
...
add_formatted_textbox(slide, reco_ta_3, 2.8, 4.05, 7, 1)
slide = prs.slides[21]
...
add_formatted_textbox(slide, reco_me_2, 2.95, 2.9, 7, 1)
slide = prs.slides[30]
add_formatted_textbox(slide, reco_me_3, 3.1, 1.3, 7, 1)
...
slide = prs.slides[7]
txBox_rec8 = slide.shapes.add_textbox(Inches(6.21), Inches(1.115), Inches(2), Inches(0.5)) #(Inches(1.36), Inches(1.165)
...
slide = prs.slides[7]
txBox_rec82 = slide.shapes.add_textbox(Inches(0.5), Inches(1.31), Inches(2), Inches(0.5)) #0.6, 1.35
